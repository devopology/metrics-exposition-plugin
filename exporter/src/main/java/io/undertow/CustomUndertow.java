...
/**
 * Custom Undertow implementation to allow using a provided XNio instance
 *
...
public final class CustomUndertow {
    ...
    private final boolean internalXnio;

    /**
     * Will be true when a {@link XnioWorker} instance was NOT provided to the {@link Builder}.
     * When true, a new worker will be created during {@link CustomUndertow#start()},
     * and shutdown when {@link CustomUndertow#stop()} is called.
     * <p>
     * Will be false when a {@link XnioWorker} instance was provided to the {@link Builder}.
     * When false, the provided {@link #worker} will be used instead of creating a new one in {@link CustomUndertow#start()}.
     * Also, when false, the {@link #worker} will NOT be shutdown when {@link CustomUndertow#stop()} is called.
     */
    ...
    private CustomUndertow(Builder builder) {
        ...
        this.internalXnio = builder.xnio == null;
    ...
    public synchronized void start() {
        if (internalXnio) {
            xnio = Xnio.getInstance(CustomUndertow.class.getClassLoader());
        }
    ...
    public static final class Builder {
        ...
        public CustomUndertow build() {
            return new CustomUndertow(this);
        }
         ...
         * when {@link CustomUndertow#start()} is called.
         * Additionally, this newly created worker will be shutdown when {@link CustomUndertow#stop()} is called.
         * <br>
         * <p>
         * When non-null, the provided {@link XnioWorker} will be reused instead of creating a new {@link XnioWorker}
         * when {@link CustomUndertow#start()} is called.
         * Additionally, the provided {@link XnioWorker} will NOT be shutdown when {@link CustomUndertow#stop()} is called.
         * Essentially, the lifecycle of the provided worker must be maintained outside of the {@link CustomUndertow} instance.
         */
        ...
        public Builder setXnio(Xnio xnio) {
            this.xnio = xnio;
            return this;
        }
