...
public class BigIntegerConverter implements Converter<BigInteger> {
    ...
    @Override
    public BigInteger convert(Object value, Required required, String description) throws ConverterException {
        ...
        if (Type.isType(String.class, value)) {
            ...
            try {
                ...
                throw new ConverterException(String.format("%s = [%s] value can't be converted to a BigInteger", description, string));
            }
        }
