...
public class StringConverter implements Converter<String> {
    ...
    @Override
    public String convert(Object value, Required required, String description) throws ConverterException {
        ...
        throw new ConverterException(String.format("%s = [%s] isn't an string", description, value));
    }
}
