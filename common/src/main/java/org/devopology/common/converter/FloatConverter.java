...
public class FloatConverter implements Converter<Float> {
    ...
    @Override
    public Float convert(Object value, Required required, String description) throws ConverterException {
        ...
        if (Type.isType(String.class, value)) {
            ...
            try {
                ...
                throw new ConverterException(String.format("%s = [%s] value can't be converted to a float", description, string));
            }
        }
